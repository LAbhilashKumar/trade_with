...
export const courses: Course[] = [
  {
    slug: "free-forex-trading-course",
    title: "Free Forex Trading Course",
    level: "Beginner",
    priceINR: 0,
    duration: "2 weeks",
    modulesCount: 5,
    tagline: "Start here — zero cost, zero risk, real foundation.",
    description:
      "A completely free introduction to the forex market — how currency pairs move, how the market actually works, and how to read your first chart without guesswork.",
    modules: [
      { title: "Module 1: Understanding Currency Pairs", lessons: 4 },
      { title: "Module 2: How the Forex Market Works", lessons: 4 },
      { title: "Module 3: Reading a Price Chart", lessons: 5 },
      { title: "Module 4: Order Types & Execution", lessons: 3 },
      { title: "Module 5: Your First Trade Plan", lessons: 3 },
    ],
    outcomes: [
      "Read and interpret major currency pairs with confidence",
      "Understand pips, lots, leverage and margin without hand-waving",
      "Place market, limit, and stop orders on any broker platform",
      "Build a simple trade plan you can actually follow",
    ],
    faqs: [
      { q: "Is this course really free?", a: "Yes — completely free, no payment or card required to access it." },
      { q: "Do I need prior trading experience?", a: "No. This course starts from zero and assumes no prior exposure to markets." },
      { q: "Is the course live or self-paced?", a: "Self-paced video lessons you can complete on your own schedule." },
      { q: "What happens after I finish?", a: "You'll be ready to move on to Forex Trading Advanced when you're ready to go deeper." },
    ],
    testimonials: [
      { name: "Rohan M.", role: "New trader, Bengaluru", quote: "Didn't expect a free course to be this structured. Finally understand what leverage actually does." },
      { name: "Priya S.", role: "Career switcher, Pune", quote: "Clear, no hype, and free. Exactly what I needed before risking real money." },
    ],
  },
  {
    slug: "forex-trading-advanced",
    title: "Forex Trading Advanced",
    level: "Advanced",
    priceINR: 9999,
    duration: "8 weeks",
    modulesCount: 9,
    featured: true,
    tagline: "Institutional-grade analysis, live sessions, and real mentorship.",
    description:
      "Our flagship program — order flow, volume profile, session opens, and confluence models used by professional discretionary traders, backed by direct mentorship.",
    modules: [
      { title: "Module 1: Market Structure & Order Flow", lessons: 5 },
      { title: "Module 2: Volume Profile & VWAP", lessons: 6 },
      { title: "Module 3: Session Opens & Killzones", lessons: 5 },
      { title: "Module 4: Liquidity Engineering", lessons: 6 },
      { title: "Module 5: Fair Value Gaps & Imbalances", lessons: 5 },
      { title: "Module 6: Correlation & DXY Framework", lessons: 4 },
      { title: "Module 7: Risk Management & Trading Psychology", lessons: 5 },
      { title: "Module 8: News-Driven Volatility", lessons: 5 },
      { title: "Module 9: Live Trade Case Studies & Mentor Review", lessons: 8 },
    ],
    outcomes: [
      "Read order flow and volume profile like a professional desk",
      "Trade session-open models with defined risk",
      "Size every trade to a fixed fractional risk model",
      "Assemble a confluence-based decision framework backed by mentor review",
    ],
    faqs: [
      { q: "Is this suitable for beginners?", a: "It's built for traders who've completed the Free Forex Trading Course or already have basic market knowledge." },
      { q: "Are live trades included?", a: "Yes — real-money trade walkthroughs with journaled reasoning and mentor feedback." },
      { q: "How long do I have access?", a: "Lifetime access with ongoing content updates." },
      { q: "How do I enroll?", a: "Pay via the details shown at checkout, upload your payment confirmation, and access unlocks once verified." },
    ],
    testimonials: [
      { name: "Vikram T.", role: "Prop-firm trader", quote: "Passed my funded challenge two weeks after the killzone module. Coincidence? Doubt it." },
      { name: "Sanjana B.", role: "Full-time trader", quote: "The DXY framework changed how I filter every setup." },
      { name: "Aditya P.", role: "Advanced graduate", quote: "The mentor review alone is worth the price. It compounds fast." },
    ],
  },
];
